...
class RelabelLogicTests(unittest.TestCase):
    ...
    def test_pickup_measure_in_middle_of_system_skips_only_that_measure(self):
        state = self._sample_state()
        state["pickup_measures"] = {"p1_s1_m1": True}
    ...
    def test_pickup_measure_at_end_of_system_skips_only_that_measure(self):
        state = self._sample_state()
    ...
    def test_pickup_measure_at_start_of_system_skips_only_that_measure(self):
        state = self._sample_state()
