...
```""",
    ...
    def test_build_system_measure_request_single_prompt_excludes_multi_staff_rules(self):
        ...
        self.assertIn("Common values in quarter-note units: whole = 4", rules_text)
        self.assertIn("A dotted note has a small black dot immediately to the right of the notehead.", rules_text)
        ...
        self.assertIn("Examples: in 2/4, one quarter note or quarter-note chord is 1 of 2 beats", rules_text)
