    ...
    intro = {
        ...
        "instructions": {
            ...
            "rules": [
                ...
                "Chords or stacked notes count as one rhythmic event, not multiple beats. Do not count each notehead separately; use the written note value of the chord or stem group.",
                "For the first measure of the score, a visibly short opening measure before the first barline is strong pickup evidence, especially in grand-staff/piano crops. Use it together with the rhythmic content: in 2/4 or 3/4, about one beat before the first barline is a pickup. Do not use width alone; a measure may look narrow because of the clef, key signature, time signature, dense notation, or crop geometry.",
                ...
                "If the first measure visibly contains fewer beats than the active time signature, choose pickup rather than normal and set measure_completeness to incomplete.",
